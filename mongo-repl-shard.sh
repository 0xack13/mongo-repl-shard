...
mongod --logpath "cfg-a.log" --dbpath data/config/config-a --port 57040 --fork --configsvr --smallfiles --replSet confRS
mongod --logpath "cfg-b.log" --dbpath data/config/config-b --port 57041 --fork --configsvr --smallfiles --replSet confRS
mongod --logpath "cfg-c.log" --dbpath data/config/config-c --port 57042 --fork --configsvr --smallfiles --replSet confRS


mongo --port 57040 << 'EOF'
config = { _id: "confRS", members:[
...
mongos --port 27018 --configdb confRS/localhost:57040,localhost:57041,localhost:57042
